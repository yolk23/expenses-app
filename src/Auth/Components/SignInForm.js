    ...
    <div className="flex items-center justify-center h-screen ">
      <div className="container mx-auto max-w-lg bg-white rounded-lg p-8 border border-black">
        ...
        <form className="border border-gray-400 rounded-lg p-8 space-y-4 min-h-[30rem]">
          ...
          <button
            onClick={submitForm}
            className="w-full bg-white hover:bg-yellow-200 text-black font-bold py-2 px-4 rounded-md focus:outline-none focus:ring focus:ring-blue-200 border border-black"
          >
            Submit
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center w-full bg-yellow-300 hover:bg-yellow-400 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring focus:ring-blue-200"
          >
